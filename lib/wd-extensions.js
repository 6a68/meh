...
// convenience methods
wd.prototype.find = wd.prototype.waitForDisplayed;
wd.prototype.win = wd.prototype.waitForWindow;

// wait for element to be displayed, then click on it.
// optionally accepts waitForDisplayed opts object instead of CSS selector
wd.prototype.click = function(opts, cb) {
  var self = this;
...
// optionally accepts waitForDisplayed opts object instead of CSS selector
wd.prototype.type = function(text, opts, cb) {
  var self = this;
  self.waitForDisplayed(opts, function(err, el) {
    if (err) return cb(err);
    self.sendKeys(text, el, cb);
  });
};

wd.prototype.findNow = wd.prototype.elementByCss;
wd.prototype.clickNow = function(which, cb) {
  var self = this;
...
wd.prototype.typeNow = function(text, which, cb) {
  var self = this;
  self.elementByCss(which, function(err, el) {
    if (err) return cb(err);
    self.sendKeys(text, el, cb);
